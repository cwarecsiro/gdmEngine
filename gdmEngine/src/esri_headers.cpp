...
void LoadASCIIHeader(std::ifstream* argFileStream,
...
void OutputASCIIHeader(std::ofstream* argFileStream,
...
void OutputFLTHeader(std::ofstream* argFileStream,
                     const int arg_n_cols,
                     const int arg_n_rows,
                     const float arg_f_xll,
                     const float arg_f_yll,
...
void OutputMCHHeader(std::ofstream* argFileStream,
                     const int arg_n_cols,
                     const int arg_n_rows,
                     const float arg_f_xll,
                     const float arg_f_yll,
...
void LoadMCHHeader(std::ifstream* argFileStream,
                   long int* arg_i_ncols_ptr,
                   long int* arg_i_nrows_ptr,
                   float* arg_f_xll_ptr,
                   float* arg_f_yll_ptr,
