...
#'@param b.dpair (float) The decay curve parameter (x-value at curve inflection point) for the distance between sites in a pair (default = half the maximum distance between sites)
