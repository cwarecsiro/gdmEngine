#'@title Non-negative least squares fitting.
#'
#'@description Function to apply non-negative least squares fitting for a GLM. Code from Andrew Hoskins (CSIRO).
#'@param x 
#'@param y 
#'@param weights Default: rep(1, nobs)
#'@param start Default: NULL 
#'@param etastart Default: NULL
#'@param mustart Default: NULL 
#'@param offset Default: rep(0, nobs) 
#'@param family Default: gaussian()
#'@param control Default: list() 
