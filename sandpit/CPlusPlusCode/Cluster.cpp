...
////////////////////////////////////////////////////////////
// Global pointers to the callback function and progress bar
#include "MyCallback.h"
extern FPTR FuncPtrGlobal;
extern void *ProgBarGlobal;
////////////////////////////////////////////////////////////
...
double** CALL distancematrix (int nrows, int ncolumns, double** data,
  int** mask, double weights[], char dist, int transpose, FPTR fptr)
/*
Purpose
=======
...
//double** CALL SymmetricDistanceMatrix (int nrows, int ncolumns, double** data,
//                                       int** mask, double weights[], char dist, 
//									   int transpose, FPTR fptr)
//{ 
//	//
//	// First determine the size of the distance matrix 
//	//
...
static Node* palcluster (int nelements, double** distmatrix, FPTR fptr)
/*
Purpose
=======
...
{ int j;
  ...
  int nCurrent = 0;
  fptr("Doing Hierachical Clustering...", nCurrent);	

  int nThis = 0;
  for (n = nelements; n > 1; n--)
  { 
	
	if ( (++nThis * 100 / nelements) > nCurrent )
	{
		nCurrent = (nThis * 100 / nelements);
		fptr("Doing Hierachical Clustering...", nCurrent);	
	}
...
Node* CALL treecluster (int nrows, int ncolumns, double** data, int** mask,
  double weight[], int transpose, char dist, char method, double** distmatrix, FPTR fptr)
/*
Purpose
=======
...
{ Node* result = NULL;
  ...
  if(ldistmatrix)
  { distmatrix =
      distancematrix(nrows, ncolumns, data, mask, weight, dist, transpose, fptr);
  ...
  { case 's':
    ...
    case 'm':
      ...
      break;
    case 'a':
      result = palcluster(nelements, distmatrix, fptr);
      break;
    case 'c':
