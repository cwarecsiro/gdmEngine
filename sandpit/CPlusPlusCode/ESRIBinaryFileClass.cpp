//
// ESRIBinaryFileClass.cpp
//
#include "stdafx.h"
#include "ESRIBinaryFileClass.h"
#include "Message.h"
...
//
void ESRIBinaryGridClass::sConvert2FLT(char *thePath, char *theReturnedPath)
{
...
//
void ESRIBinaryGridClass::sConvert2HDR(char *thePath, char *theReturnedPath)
{
	char Drive[_MAX_DRIVE];
	char Dir[_MAX_DIR];
	char Name[_MAX_FNAME];
