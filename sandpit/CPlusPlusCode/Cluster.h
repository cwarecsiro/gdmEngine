...
int** mask, double* weight, char dist, int transpose, FPTR fptr);

//double** CALL SymmetricDistanceMatrix (int ngenes, int ndata, double** data,
//                                       int** mask, double* weight, char dist, 
